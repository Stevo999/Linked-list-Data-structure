...
#include <iomanip>
#include "sequence.h"
//#define __GRADING //Leave this commented out from your tests
...
int main() {
    ...
    try {
        ...
        OUTSTREAM << "Should be: <0, 1, 2> <100, 101, 102>" << endl << endl;
#else
        OUTSTREAM << "*** UNHANDLED CRASH DURING TESTING ***" << endl << endl;
#endif
    } catch (exception& e) {
    ...
    try {
        ...
        data.insert(5, 555);
        OUTSTREAM << "ERROR: insert() DID NOT throw an exception" << endl << endl;
#else
        OUTSTREAM << "*** UNHANDLED CRASH DURING TESTING ***" << endl << endl;
#endif
    } catch (exception& e) {
    ...
    try {
        ...
        OUTSTREAM << "Sequence: " << data << endl;
        OUTSTREAM << "Should be: 100 <100, 200, 300>" << endl << endl;
    ...
    try {
        ...
        OUTSTREAM << "Sequence: " << data << endl;
        OUTSTREAM << "Should be: 300 " << endl << endl;
        OUTSTREAM << "           <100, 200, 300>" <<endl <<endl;
#else
        OUTSTREAM << "*** UNHANDLED CRASH DURING TESTING ***" << endl << endl;
#endif
